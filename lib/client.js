...
var genMasking_key = util.genMasking_key;
...
function Client(socket, sockets_queue) {
  ...
  Object.defineProperty(this, 'needDrain', {
    get: function () {
      return this.socket._writableState.needDrain;
    }
  });
...
Client.prototype.close = function (code, reason, mask) {
  // if this endpoint has sent the close frame, do nothing
  this.isCloseFrameSent || this.emitCtrl(0x8, code, reason, mask);
...
Client.prototype.emit = function (e, data, mask) {
  ...
  var FIN = 1, 
      MASK = 0, 
      Masking_key = [],
      Opcode = util.isBuffer(data) ? 0x2 : 0x1;
  var fragment = 0;
  var frame = null;
  var head_len;
